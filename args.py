...
parser.add_argument('-pn', '--prototype_num', type=int, default=10)
...
pnfrl_args.folder_name = '_{}_{}_{}_gNum_{}_ws_{}_e_{}_pNum_{}_lr{}_bs{}'.format(
    pnfrl_args.data_set, pnfrl_args.setting, pnfrl_args.bert_model_name, pnfrl_args.gaussian_num, pnfrl_args.window_size, pnfrl_args.epoch, pnfrl_args.prototype_num,  pnfrl_args.learning_rate, pnfrl_args.batch_size)
pnfrl_args.base_folder = "Datasets"
if pnfrl_args.data_set == "IMDB":
    pnfrl_args.dataset_path = "/Datasets/IMDB/IMDB Dataset.csv"
elif pnfrl_args.data_set == 'Amazon':
    pnfrl_args.dataset_path = "/scratch/nkw3mr/intepre_clinical_long_doc/ProtoLens/Datasets/Amazon"
else: 
...
print(f"Model path: {pnfrl_args.model_path}")
